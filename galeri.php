				...
				<div class="container">
					<div class="row">
							...
							<div id="content">
								...
								<section class="visual">
									...
									<div class="row">
										...
										<div class="col-sm-4">
											<div class="hold-photo">
												<img src="aset/paket/images/img06.jpg" alt="image" width="270" height="208">
												<div class="frame-shadow">&nbsp;</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="hold-photo">
												<img src="aset/paket/images/img08.jpg" alt="image" width="270" height="208">
												<div class="frame-shadow">&nbsp;</div>
											</div>
										</div>
										<div class="col-sm-4">
											<div class="hold-photo">
												<img src="aset/paket/images/img09.jpg" alt="image" width="270" height="208">
												<div class="frame-shadow">&nbsp;</div>
										...
										<div class="col-sm-4">
											<div class="hold-photo">
												<img src="aset/paket/images/img10.jpg" alt="image" width="270" height="208">
												<div class="frame-shadow">&nbsp;</div>
											</div>
										</div>
									</div>
								...
								<div class="wrap-space">
									<ul class="pagination pagination-lg pagination-business">
										<li class="prev"><a href="404.php">«</a></li><li>
											<a href="404.php">1</a></li><li class="active">
											<a href="404.php">2</a></li><li>
											<a href="404.php">3</a></li><li>
											<a href="404.php">4</a></li><li>
						...
						<div class="col-md-3 col-sm-4">
							<!-- sidebar  start -->
							<aside id="sidebar" class="more" style="background:white">
								<div class="hold-line">
									<h2 style="font-family:Open Sans">Kategori Album</h2>
									<hr/>
									<ul class="list">
										<li>
											<a href="404.php">Lanji</a>
											<span class="number">(8)</span>
										</li>
										<li>
											<a href="404.php">Kelas</a>
											<span class="number">(10)</span>
										</li>
										<li>
											<a href="404.php">Balikpapan</a>
