				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 kiri">
							<strong class="logo"><a href="index.php"><img src="aset/img/logo1.png" alt="Logo"></a></strong>
						</div>
						<div class="col-sm-8 kanan">
									...
									<div class="frame pull-right">
										...
										<div class="profiles-box pull-right active">
											...
											<ul class="tools tools-middle pull-left">
												<li><a href="https://web.facebook.com/manz157" target="_blank"><span class="fa-icon-facebook-sign"></span></a></li>
							...
							<?php @include("welcomenavigation.php")?>
						</div>
					</div>
				</div>
			</header>