											...
											<nav class="navbar navbar-default navbar-business" role="navigation">
												...
												<div class="collapse navbar-collapse">
													...
													<ul class="nav navbar-nav">
														...
														<li class="active dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Profil Sekolah</a>
				...
				<div class="hold-breadcrumbs">
					<div class="container">
						<ol class="breadcrumb breadcrumb-site">
							<li><a href="index.php">Beranda</a></li>
							<li><a href="404.php">Profil Sekolah</a></li>
						...
						<div class="container">
							...
							<div class="row">
								<div class="visi-sekolah">
									<h1 style="font-family:Open Sans">Visi Sekolah</h1>
									<hr/>
									<p style="font-size:17px">“Terwujudnya peserta didik yang bertaqwa, cerdas, kompeten, mandiri dan berdaya saing global”</p>
								</div>
							</div>
							<br/>
							<br/>
							...
							<div class="row">
								<div class="misi-sekolah">
									<h1 style="font-family:Open Sans">Misi Sekolah</h1>
									<hr/>
									<ul style="font-size:17px">
										<li>Menanamkan keimanan dan ketaqwaan melalui pengamalan ajaran Agama;</li>
										<li>Mengoptimalkan proses pembelajaran yang berbasis teknologi berdasarkan penerapan kurikulum 2013;</li>
										<li>Memberdayakan dan mengembangkan sarana/prasarana untuk mendukung proses pembelajaran yang berkualitas;</li>
										<li>Meningkatkan profil kemampuan tenaga pendidik dan tenaga kependidikan menjadi tenaga yang profesional dibidangnya;</li>
										<li>Menjadikan SMKS PGRI 1 Sukabumi menjadi sekolah pavorit di masyarakat;</li>
										<li>Menghasilkan lulusan yang profesional dibidang teknologi untuk memenuhi tuntutan dunia usaha dan dunia indsutri;</li>
										<li>Membekali peserta didik dengan kemampuan untuk mengembangkan diri secara mandiri;</li>
										<li>Menyiapkan lulusan yang kompeten, profesional dan mampu mandiri untuk memenuhi pasar kerja baik tingkat lokal, nasional maupun internasional.</li>
									</ul>
								</div>
							</div>
						</div>
