					...
					<div class="holder">
						<div class="container">
							<div class="jumbotron">
								...
								<figure class="hold-img text-center"><img src="aset/paket/images/img163.jpg" alt="image" width="475" height="105"></figure>
								<p class="text-center">Sepertinya yang sedang Anda cari tidak ditemukan. Coba manfaatkan fasilitas pencarian berikut?</p>
							</div>
							<div class="row">
								<div class="col-sm-6 col-sm-offset-3">
									<form action="404.php">
										<fieldset>
											<div class="field-search field-large">
